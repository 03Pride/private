...
__BSP_CAN_EXT uint8_t CAN1_Rx_data[8];	
__BSP_CAN_EXT uint8_t CAN1_Tx_data[8];
__BSP_CAN_EXT uint8_t CAN2_Rx_data[8];	
__BSP_CAN_EXT uint8_t CAN2_Tx_data[8];
